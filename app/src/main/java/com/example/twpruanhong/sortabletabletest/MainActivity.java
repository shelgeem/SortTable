...
import com.example.data.CarProducer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SortableCarView sortableCarView = (SortableCarView) findViewById(R.id.self_sortable);
        sortableCarView.setDataAdapter(new CarDataAdapter(MainActivity.this,createAndGiveCarList()));
    }

    private static List<Car> createAndGiveCarList() {
        final CarProducer audi = new CarProducer(R.drawable.ic_launcher, "Audi");
        ...
        final CarProducer bmw = new CarProducer(R.drawable.ic_launcher, "BMW");
        ...
        final CarProducer porsche = new CarProducer(R.drawable.ic_launcher, "Porsche");
